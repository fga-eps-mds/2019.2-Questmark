...
Passport é um middleware de autenticação para NodeJS, extremamente flexivél e modular. Passportjs  pode 
...
A Estratégia adotado no Questmark foi a local
